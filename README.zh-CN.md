...
<!--
新项目加在对应月份的最上面（没有这个月就新建一个 ### 月份标题），照下面的模板写：

#### 方案名（按 AI 解决方案岗位的说法命名）
`YYYY.MM` · `原项目名` · 个人 / 团队项目 · 真实场景 / 合成数据原型 · [仓库 →](链接)
...
`2026.09` · `Project Report A` · 个人主导 · 真实场景（家族委托，草案阶段） · [报告 PDF →](evidence/Project_Report_A_Legacy_Rights_Consolidation.pdf)
...
#### 小微餐饮档口的 AI 辅助开业方案
`2026.09` · `Project Report B` · 个人主导 · 真实场景（首店验证期） · [报告 PDF →](evidence/Project_Report_B_Micro_Retail_Launch.pdf)
...
#### 跨境支付反洗钱调查分诊方案
`2026.09` · `CrossBorder RiskOps` · 个人项目 · 合成数据原型 · [仓库 →](https://github.com/joshuazou-web/crossborder-riskops)
...
#### 证券研究问答的证据与质检层
`2026.09` · `WealthGuard Proofline` · 个人项目 · 合成数据原型 · [仓库 →](https://github.com/joshuazou-web/wealthguard-proofline)
...
`2026.09` · `PropTech Agent Reliability Lab` · 个人项目 · 合成数据练习场 · [仓库 →](https://github.com/joshuazou-web/proptech-agent-reliability-lab)
...
#### 电商对话式导购：反向用户建模检索
`2026.09` · `Converge` · 个人参赛 · TikTok TechJam 2026 · [仓库 →](https://github.com/joshuazou-web/techjam-converge)
...
#### IT 工单智能分诊与运营看板方案
`2026.08` · `OpsSignal` · 个人项目 · 合成数据原型 · [仓库 →](https://github.com/joshuazou-web/opssignal)
...
#### Agent 评测结论稳健性审计工具
`2026.08` · `DecisiveEval` · 个人项目 · v0.1 研究原型 · [仓库 →](https://github.com/joshuazou-web/decisive-eval)
...
#### 中文开发者 API 报错安全诊断工作台
`2026.08` · `DEBUG.CN` · 个人项目 · 可运行 Demo · [仓库 →](https://github.com/joshuazou-web/mandarin-openai-api-debugging-copilot)
...
#### 课程答辩 AI 陪练
`2026.08` · `白盒 wbox` · 个人项目 · MVP · [仓库 →](https://github.com/joshuazou-web/wbox)
...
#### 编码 Agent 三层安全门禁
`2026.07` · `Volc Agent Launchpad` · 个人参赛 · TechJam 2026 · [仓库 →](https://github.com/joshuazou-web/volc-agent-launchpad)
...
#### 支付前反诈干预方案
`2026.07` · `ThinkBeforeClick FinSafe` · 个人 P0（基于 5 人团队原型） · 合成数据原型 · [仓库 →](https://github.com/joshuazou-web/think-before-click-product-case)
...
#### 外汇策略的研究—监控—执行产品化
`2026.07` · `Algorithmic FX` · NUS 5 人团队项目 · 合成数据原型 · [仓库 →](https://github.com/joshuazou-web/algorithmic-fx-product-case)
...
#### 风险分驱动的借贷条款设计
`2026.07` · `Risk-Based DeFi Lending` · NUS 5 人团队项目 · 在线演示 · [仓库 →](https://github.com/joshuazou-web/risk-based-defi-lending-case-study)
...
#### 企业 Agent 权限管控与审计内核
`2026.06` · `Agent Control Plane` · 个人项目 · 可用 CLI · [仓库 →](https://github.com/joshuazou-web/agent-control-plane)
...
#### 量化竞赛策略的反过拟合研究协议
`2026.05` · `Frozen High-Beta Leader` · 个人参赛 · SoAI 2026 · [仓库 →](https://github.com/joshuazou-web/SoAI-2026-High-Beta-Leader)
...
#### 自适应反钓鱼培训 SaaS
`2025.11` · `ThinkBeforeClick` · NUS 5 人团队项目 · 用户测试 · [产品报告 PDF →](evidence/ThinkBeforeClick_Product_Report.pdf)
...
#### 智能服装制造设备的商业化落地
`2023` · `AI Star` · 投资人兼产品商业化负责人 · 真实业务 · [产品目录 PDF →](evidence/AIStar_Product_Catalogue.pdf)
