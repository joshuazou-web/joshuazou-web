...
| 能力 | 这组项目证明什么 | 项目 |
| --- | --- | --- |
| **[01 · 把模糊的现场问题，落成能执行的方案](#solve)** | 需求说不清、信息不全时，能诊断问题并交付对方照着做的方案 | 5 个 |
| **[02 · 给 AI 划清边界，并证明它可信](#ai)** | 能决定 AI 该做什么、不该做什么，并用评测证明它可信 | 6 个 |
| **[03 · 把金融规则与风险，做成产品机制](#fin)** | 能把合规、风控和交易纪律变成可解释、可复算的产品规则 | 7 个 |

<!--
新项目放进最能说明它的那一组，照下面的模板写：
