...
- [存量合同档案的 LLM 辅助梳理与确权方案](#contracts)：把 39 页手写扫描件理成一条时间线和 5 份文书草案
- [小微餐饮档口的 AI 辅助开业方案](#stall)：只凭一张照片和两段语音，做出可施工、带验收清单的开业方案
